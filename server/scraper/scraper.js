...
async function scrapeSites() {
    ...
    const context = browser.defaultBrowserContext();
        ...
        //     if (i <= 10) {
                await marketFunction.scrapeNewWorldPakSave("https://www.ishopnewworld.co.nz/category/baby-toddler-and-kids?ps=50&pg=", 1, context, page, PakAndSaveProduct, 'PakSave', categorys.baby)
        //     }
