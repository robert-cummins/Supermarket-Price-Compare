    ...
    page.on('request', (req) => {
        ...
        for (let i = 1; i <= 20; i++) {
            if (i <= 2) {
                ...
                await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/liquor-beer-cider?page=", 1, context, page, CountdownProduct, categorys.alcohol)
            }
            if (i <= 3) {
                ...
                await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/fruit-vegetables?page=", 1, context, page, CountdownProduct, categorys.fresh)
            }
            ...
            if (i <= 13) { await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/meal-ingredients?page=", i, context, page, CountdownProduct, categorys.pantry) }
            if (i <= 14) {
