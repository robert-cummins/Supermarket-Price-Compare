...
async function scrapeSites() {
    ...
    for (let i = 1; i <= 20; i++) {
        if (i <= 2) {
            await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/meat?page=", i, page, CountdownProduct)
            await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/seafood?page=", i, page, CountdownProduct)
            await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/liquor-beer-cider?page=", i, page, CountdownProduct)
        }
        if (i <= 3) {
            ...
            await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/fruit-vegetables?page=", i, page, CountdownProduct)
        }
        if (i <= 4) { await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/bakery?page=", i, page, CountdownProduct) }
        if (i <= 5) {
            ...
            await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/baby-care?page=", i, page, CountdownProduct)
            await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/canned-prepared-foods?page=", i, page, CountdownProduct)
        }
        if (i <= 6) {
        ...
        if (i <= 7) {
            ...
            await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/frozen-foods?page=", i, page, CountdownProduct)

        }
        if (i <= 8) { await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/baking-cooking?page=", i, page, CountdownProduct) }
        if (i <= 9) {
            ...
            await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/liquor-wine?page=", i, page, CountdownProduct)
            await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/cleaning-homecare?page=", i, page, CountdownProduct)

        }
        if (i <= 10) { await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/chocolate-sweets-snacks?page=", i, page, CountdownProduct) }
        if (i <= 11) { await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/drinks-hot-cold?page=", i, page, CountdownProduct) }
        if (i <= 13) { await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/deli-chilled-foods?page=", i, page, CountdownProduct) }
        if (i <= 14) {
        ...
        await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/personal-care?page=", i, page, CountdownProduct)
