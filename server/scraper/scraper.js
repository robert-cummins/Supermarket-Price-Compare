...
async function scrapeSites() {
    ...
    const context = browser.defaultBrowserContext();
        ...
        //         await marketFunction.scrapeCountdown("https://shop.countdown.co.nz/shop/browse/frozen?page=", i, context, page, CountdownProduct, categorys.frozen)
                await marketFunction.scrapeNewWorldPakSave("https://www.paknsaveonline.co.nz/category/baby-toddler-and-kids?ps=50&pg=", 1, context, page, PakAndSaveProduct, 'PakSave', categorys.baby)
        //     }
