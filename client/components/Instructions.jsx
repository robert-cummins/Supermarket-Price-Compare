...
const Instructions = () => {
    return (
        <div className="ui container">
            <p className="intro">
                Welcome to Supermarket Price Compare. This app allows you to see exactly how much an individual item or whole shopping list will cost at New Zealand's biggest supermarket chains. 
            </p>
            <ul>
