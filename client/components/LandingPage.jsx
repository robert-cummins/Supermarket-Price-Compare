        ...
        return (
            <>
                <div className="ui container">
                    ...
                    <SearchBar />
                    <p>Search for items on your shopping list for example "nescafe coffee" using the search bar and hit enter to see the search results from each supermarket. Add the preferred item from each of the 3 supermarket tables displayed after the search. <br/> Click on the "shopping basket" tab at any time to see the total running cost for each supermarket. <br/> Use the catagory check boxes to narrow large search results.<br/> This is hosted for free and is a little slow to start up. If you do not receive results from all 3 supermarkets, refresh the page and wait 10 seconds before making a search. This will only be a problem for the first search</p>
                </div>
